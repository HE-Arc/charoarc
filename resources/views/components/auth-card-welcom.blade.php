<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100" style="--bg-opacity: 1;
    ...
    <div style="display:flex; flex-direction: row;justify-content:space-around; vertical-align: baseline; display:flex; flex-direction: column;justify-content:space-around;width:30%">
        {{ $logo }}
    </div>
